  ...
  "flex items-center gap-2 text-sm shadow-none",
  {
    variants: {
      size: {
        ...
        "icon-md": "size-9 rounded-sm p-0 has-[>svg]:p-0 [&>svg:not([class*='size-'])]:size-5 text-muted-foreground hover:text-foreground transition-colors",
      },
    },
    defaultVariants: {
      size: "xs",
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        "flex-1 rounded-sm border-0 bg-transparent shadow-none ring-0 focus-visible:ring-0 aria-invalid:ring-0 dark:bg-transparent",
        className
      )}
      {...props}
    />
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      data-slot="input-group-control"
      className={cn(
        "flex-1 resize-none rounded-sm border-0 bg-transparent py-2 shadow-none ring-0 focus-visible:ring-0 aria-invalid:ring-0 dark:bg-transparent",
        className
      )}
      {...props}
    />
